...
public class TbEmpData implements Serializable {
    ...
    @Length(max = 150, message = "POST_ALL 长度不能超过150")
    ...
    @Length(max = 40, message = "JOB_WAIT_ID 长度不能超过40")
    ...
    @Length(max = 200, message = "WORK_POST 长度不能超过200")
    ...
    @NotNull(message = "MF_ID not allow null")
    @Id
    @Column(name = "MF_ID")
    private String mfId;
