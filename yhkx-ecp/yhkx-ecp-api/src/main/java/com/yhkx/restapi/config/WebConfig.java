package com.yhkx.restapi.config;

import brave.spring.webmvc.TracingHandlerInterceptor;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.yhkx.core.configuration.ProtostuffHttpMessageConverter;
import com.yhkx.core.util.DateConverter;
import com.yhkx.restapi.apiversion.VersionHandlerMapping;
import com.yhkx.restapi.exception.PrometheusMetricsInterceptor;
import com.yhkx.restapi.filter.CommonFilterOne;
import com.yhkx.restapi.filter.CommonFilterTwo;
...
@Configuration
@ComponentScan(basePackages = {"com.yhkx.core.*", "com.yhkx.restapi.*"})
public class WebConfig extends WebMvcConfigurationSupport {
    ...
    public FilterRegistrationBean filterRegistrationBean() {
        ...
        CommonFilterOne commonFilterOne = new CommonFilterOne();
        registrationBean.setFilter(commonFilterOne);
    ...
    public FilterRegistrationBean filterRegistrationBean2() {
        FilterRegistrationBean registrationBean = new FilterRegistrationBean();
        CommonFilterTwo commonFilterTwo = new CommonFilterTwo();
        registrationBean.setFilter(commonFilterTwo);
        registrationBean.addUrlPatterns("/*");
